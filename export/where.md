...
| `Glossary-Python` | подключён | 0 | 0 | 181 | 0 | 0 | 110 | 46 | 10 | 28 | 26 | 58 |  |
...
| `Glossary-Python` | `.github/workflows/ci.yml` | 10 |
...
| `Glossary-Python` | _остальные_ · _the rest_ | 26 механизмов по одному правилу; без названного адреса: 0 из 84 |
