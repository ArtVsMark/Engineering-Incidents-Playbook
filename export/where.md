...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `Engineering-Incidents-Playbook` | подключён | 35 | 27 | 179 | 0 | 0 | 141 | 102 | 8 | 25 | 6 | 90 |  |
...
| `Engineering-Incidents-Playbook` | _остальные_ · _the rest_ | 43 механизмов по одному правилу; без названного адреса: 0 из 135 |
