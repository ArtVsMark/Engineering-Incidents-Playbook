...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `Engineering-Incidents-Playbook` | подключён | 37 | 29 | 182 | 0 | 0 | 149 | 112 | 8 | 26 | 3 | 98 |  |
| `Stepik-Python-Grader` | подключён | 69 | 130 | 181 | 1 | 0 | 178 | 76 | 37 | 65 | 0 | 142 |  |
| `ArtVsMark` | подключён | 16 | 10 | 181 | 1 | 0 | 108 | 74 | 11 | 21 | 0 | 35 |  |
| `Claude-Code_Usage-Token` | подключён | 12 | 13 | 181 | 1 | 0 | 152 | 91 | 9 | 46 | 6 | 78 |  |
| `Glossary-Python` | подключён | 0 | 0 | 181 | 1 | 0 | 117 | 60 | 12 | 29 | 16 | 78 |  |
...
| `Engineering-Incidents-Playbook` | `scripts/check_bindings.py` | 12 |
...
| `Engineering-Incidents-Playbook` | _остальные_ · _the rest_ | 42 механизмов по одному правилу; без названного адреса: 0 из 146 |
...
| `Claude-Code_Usage-Token` | `CLAUDE.md` | 33 |
...
| `Claude-Code_Usage-Token` | _остальные_ · _the rest_ | 29 механизмов по одному правилу; без названного адреса: 0 из 146 |
