...
| `Claude-Code_Usage-Token` | подключён | 12 | 13 | 181 | 0 | 0 | 152 | 91 | 9 | 36 | 16 | 76 |  |
...
| `Claude-Code_Usage-Token` | `scripts/concurrency_head.py` | 2 |
...
| `Claude-Code_Usage-Token` | _остальные_ · _the rest_ | 27 механизмов по одному правилу; без названного адреса: 0 из 136 |
