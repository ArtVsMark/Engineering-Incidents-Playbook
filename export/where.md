...
| `Claude-Code_Usage-Token` | подключён | 9 | 10 | 175 | 0 | 0 | 120 | 80 | 4 | 26 | 10 | 57 |  |
...
| `Claude-Code_Usage-Token` | `scripts/preflight.py` | 24 |
| `Claude-Code_Usage-Token` | `CLAUDE.md` | 21 |
| `Claude-Code_Usage-Token` | `docs/spec.md` | 12 |
...
| `Claude-Code_Usage-Token` | `src/claude_code_usage/whitelist.py` | 8 |
| `Claude-Code_Usage-Token` | `.github/workflows/rules-inbox.yml` | 7 |
...
| `Claude-Code_Usage-Token` | `src/claude_code_usage/storage.py` | 4 |
...
| `Claude-Code_Usage-Token` | _остальные_ · _the rest_ | 14 механизмов по одному правилу; без названного адреса: 0 из 110 |
