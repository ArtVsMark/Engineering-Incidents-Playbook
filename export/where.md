...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `Engineering-Incidents-Playbook` | подключён | 29 | 23 | 162 | 0 | 0 | 120 | 81 | 4 | 23 | 12 | 0 | 74 |  |
...
| `Engineering-Incidents-Playbook` | _остальные_ · _the rest_ | 37 механизмов по одному правилу; без названного адреса: 0 из 108 |
