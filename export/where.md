...
| `Claude-Code_Usage-Token` | `CLAUDE.md` | 20 |
| `Claude-Code_Usage-Token` | `scripts/preflight.py` | 20 |
...
| `Claude-Code_Usage-Token` | `scripts/rules_answer.py` | 9 |
...
| `Claude-Code_Usage-Token` | `.github/workflows/rules-inbox.yml` | 5 |
