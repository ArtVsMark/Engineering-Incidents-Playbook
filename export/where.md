...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `claude-code-playbook` | подключён | 25 | 19 | 154 | 0 | 0 | 112 | 61 | 3 | 14 | 34 | 0 | 52 |  |
...
| `claude-code-playbook` | _остальные_ · _the rest_ | 20 механизмов по одному правилу; без названного адреса: 0 из 78 |
