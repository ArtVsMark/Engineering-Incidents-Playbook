...
ОТДАЁТСЯ ПОТРЕБИТЕЛЮ. Запускается у каталога, а собранный набор человек
несёт в свой репозиторий; названо в CONNECT.md (правило 163).
...
же правка разведёт их (090). Отсюда и форма: скрипт КЛАДЁТ файлы в
...
035). Маркер в export/README.md переписывает выпуск.
...
PROPOSALS = {
    "_": ("Правила, родившиеся ЗДЕСЬ и предлагаемые общему каталогу. Адрес этого "
          ...
          "proposals. Контракт: "
          f"https://github.com/{CATALOGUE}/blob/main/export/README.md"),
