...
Реализует правила каталога:
  088 — объявленные исходы гейта прогоняются подделкой с обеих сторон: вопрос
        критика о методе, а не о продукте, задаётся машиной.
  ...
  183 — таблица гейтов в своде есть утверждение о конвейере: она сверяется
        с шагами ci.yml, которые исполняет площадка;
