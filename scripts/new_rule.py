...
#: предложения и половиной — `where` в ответах потребителей.
...
def trail_resolves(trail: str, root: Path) -> bool:
    ...
    потребителей: два ответа на один вопрос разъезжаются молча.
    """
...
def main(argv: list[str] | None = None) -> int:
    ...
    # (209) — вторая копия имени разошлась бы молча.
